...
Puis ouvrir une PR sur GitHub en décrivant :
- Les composants/tokens ajoutés ou modifiés
- Les screenshots Storybook si le rendu change
- Les éventuelles breaking changes
