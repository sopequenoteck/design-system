...
<table style={{width: '100%', borderCollapse: 'collapse', marginBottom: '16px'}}>
  <thead>
    <tr style={{borderBottom: '2px solid var(--border-color, #e5e5e5)'}}>
      <th style={{textAlign: 'left', padding: '12px 16px', fontWeight: 600}}>Métrique</th>
      <th style={{textAlign: 'left', padding: '12px 16px', fontWeight: 600, width: '120px'}}>Valeur</th>
      <th style={{textAlign: 'left', padding: '12px 16px', fontWeight: 600, width: '140px'}}>Objectif</th>
    </tr>
  </thead>
  <tbody>
    <tr style={{borderBottom: '1px solid var(--border-color, #e5e5e5)'}}>
      <td style={{padding: '12px 16px'}}>Tests unitaires</td>
      <td style={{padding: '12px 16px'}}>1300+</td>
      <td style={{padding: '12px 16px'}}>100% passants</td>
    </tr>
    <tr style={{borderBottom: '1px solid var(--border-color, #e5e5e5)'}}>
      <td style={{padding: '12px 16px'}}>Couverture Statements</td>
      <td style={{padding: '12px 16px'}}>92%+</td>
      <td style={{padding: '12px 16px'}}>≥80%</td>
    </tr>
    <tr style={{borderBottom: '1px solid var(--border-color, #e5e5e5)'}}>
      <td style={{padding: '12px 16px'}}>Couverture Branches</td>
      <td style={{padding: '12px 16px'}}>83%+</td>
      <td style={{padding: '12px 16px'}}>≥80%</td>
    </tr>
    <tr style={{borderBottom: '1px solid var(--border-color, #e5e5e5)'}}>
      <td style={{padding: '12px 16px'}}>Tests E2E</td>
      <td style={{padding: '12px 16px'}}>52+</td>
      <td style={{padding: '12px 16px'}}>100 à terme</td>
    </tr>
    <tr>
      <td style={{padding: '12px 16px'}}>Visual snapshots</td>
      <td style={{padding: '12px 16px'}}>80+</td>
      <td style={{padding: '12px 16px'}}>En place</td>
    </tr>
  </tbody>
</table>
