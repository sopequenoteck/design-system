...
| `minTime` | `string \| null` | `null` | Heure minimale sélectionnable |
| `maxTime` | `string \| null` | `null` | Heure maximale sélectionnable |
...
| `minTime` | `string \| null` | `null` | Contrainte min |
| `maxTime` | `string \| null` | `null` | Contrainte max |
...
| `isDisabled` | `boolean` | Combinaison disabled \|\| readonly |
