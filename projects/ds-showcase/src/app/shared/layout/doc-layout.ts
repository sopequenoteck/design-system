...
export class DocLayout {
  ...
  /** Groupes ouverts - Composants fermé par défaut */
      ...
      children: [
        {
          ...
          label: 'Formulaires',
          children: [
            { id: 'demo-login', label: 'Login', path: '/demos/forms/login' },
            { id: 'demo-contact', label: 'Contact', path: '/demos/forms/contact' },
            { id: 'demo-settings', label: 'Settings', path: '/demos/forms/settings' },
          ],
        },
        {
          id: 'demos-navigation',
          label: 'Navigation',
          children: [
            { id: 'demo-sidebar-layout', label: 'Sidebar Layout', path: '/demos/navigation/sidebar-layout' },
            { id: 'demo-header', label: 'Header', path: '/demos/navigation/header' },
          ],
        },
        {
          id: 'demos-data',
        ...
        },
        {
          ...
          label: 'Feedback',
          children: [
            { id: 'demo-notifications', label: 'Notifications', path: '/demos/feedback/notifications' },
            { id: 'demo-loading-states', label: 'Loading States', path: '/demos/feedback/loading-states' },
          ],
        },
      ],
    },
