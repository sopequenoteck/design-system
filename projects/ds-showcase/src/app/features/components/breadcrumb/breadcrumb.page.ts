...
import { DsBreadcrumbDefinition } from '../../../registry/definitions/ds-breadcrumb.definition';
import { ControlValues } from '../../../registry/types';

@Component({
  selector: 'app-breadcrumb-page',
  standalone: true,
  imports: [DsBreadcrumb, DemoContainer, PropsTable],
  template: `
    <div class="component-page">
      ...
      <section class="component-section">
        ...
        <div class="demo-block">
          ...
          <p class="demo-block__desc">Fil d'Ariane basique.</p>
          <doc-demo-container
        ...
        <div class="demo-block">
          <h3 class="demo-block__title">Custom Separator</h3>
          <p class="demo-block__desc">Séparateur personnalisé.</p>
        ...
        <div class="demo-block">
          <h3 class="demo-block__title">With Max Items</h3>
          <p class="demo-block__desc">Nombre maximum d'items affiché avec ellipsis.</p>
        ...
        <div class="demo-block">
          <h3 class="demo-block__title">With Links</h3>
          <p class="demo-block__desc">Items cliquables avec liens.</p>
          <doc-demo-container [code]="definition.demos[3].code">
            <ds-breadcrumb
              [items]="linkedBreadcrumbItems"
              (itemClicked)="onItemClick($event)"
            />
          </doc-demo-container>
        </div>
...
export class BreadcrumbPage {
  definition = DsBreadcrumbDefinition;
  ...
  longBreadcrumbItems: BreadcrumbItem[] = [
    { label: 'Accueil' },
    { label: 'Produits' },
    { label: 'Catégorie' },
  ...
  linkedBreadcrumbItems: BreadcrumbItem[] = [
    { label: 'Accueil', href: '/' },
  ...
  demoSeparator = () => this.defaultValues()['separator'] as string;
