...
import { DsFileUpload, FileUploadSize } from 'ds-angular';
import { DemoContainer } from '../../../shared/demo/demo-container';
import { PropsTable } from '../../../shared/props/props-table';
import { DsFileUploadDefinition } from '../../../registry/definitions/ds-file-upload.definition';
import { ControlValues } from '../../../registry/types';

@Component({
  selector: 'app-file-upload-page',
  standalone: true,
  imports: [DsFileUpload, DemoContainer, PropsTable],
  template: `
    <div class="component-page">
      ...
      <section class="component-section">
        ...
        <div class="demo-block">
          ...
          <p class="demo-block__desc">File upload avec contrôles interactifs.</p>
          <doc-demo-container
        ...
        <div class="demo-block">
          <h3 class="demo-block__title">Images Only</h3>
          <p class="demo-block__desc">Accepte uniquement les images.</p>
        ...
        <div class="demo-block">
          <h3 class="demo-block__title">Multiple Files</h3>
          <p class="demo-block__desc">Upload de plusieurs fichiers (max 5).</p>
        ...
        <div class="demo-block">
          <h3 class="demo-block__title">Custom Size Limit</h3>
          <p class="demo-block__desc">Limite de taille personnalisée (2 MB).</p>
...
export class FileUploadPage {
  definition = DsFileUploadDefinition;
  ...
  demoSize = computed(() => this.defaultValues()['size'] as FileUploadSize);
  demoMultiple = computed(() => this.defaultValues()['multiple'] as boolean);
  demoShowPreview = computed(() => this.defaultValues()['showPreview'] as boolean);
