...
import { DsInputTextarea, TextareaSize } from 'ds-angular';
    ...
    <div class="component-page">
      ...
      <section class="component-section">
        ...
        <div class="demo-block">
          ...
          <p class="demo-block__desc">Textarea avec compteur de caractères.</p>
        ...
        <div class="demo-block">
          ...
          <p class="demo-block__desc">Textarea en état d'erreur.</p>
        ...
        <div class="demo-block">
          ...
          <doc-demo-container [code]="definition.demos[3].code">
            <div class="demo-column">
              <ds-input-textarea size="sm" label="Small" [rows]="2" />
        ...
        <div class="demo-block">
          <h3 class="demo-block__title">Readonly</h3>
          <p class="demo-block__desc">Textarea en lecture seule.</p>
...
export class InputTextareaPage {
  definition = DsInputTextareaDefinition;
  ...
  demoRows = computed(() => this.defaultValues()['rows'] as number);
